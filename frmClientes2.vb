...
#End Region
    ...
    Private Sub ImportExcel_Click(sender As Object, e As EventArgs) Handles ImportExcel.Click
        ...
        '    End If
        'End With
        Using ofd As OpenFileDialog = New OpenFileDialog() With {.Filter = "Excel Files|*.xls;*.xlsx;*.xlsm"}
    ...
    Private Sub cboSheet_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboSheet.SelectedIndexChanged
        ...
        DataGridView2.Columns.Add("Recetas", "Recetas")
        DataGridView2.Columns.Add("Recaudado", "Recaudado")
        DataGridView2.Columns.Add("A cargo OS", "A cargo OS")
        DataGridView2.Columns.Add("Bonificacion", "Bonificacion")
        DataGridView2.Columns.Add("Total", "Total")

        Dim j As Integer
        For j = 0 To DataGridView1.Rows.Count - 1
            If TypeOf DataGridView1.Rows(j).Cells(3).Value Is DBNull = False Then
                ...
                'End If
                'DataGridView2.Rows.Add(DataGridView1.Rows(j).Cells(3).Value)
                'DataGridView2.Rows(j).Cells(3).Value = DataGridView1.Rows(j).Cells(3).Value
        ...
        Dim max As Integer = DataGridView1.Columns.Count
    ...
    Private Sub NumericUpDown1_ValueChanged(sender As Object, e As EventArgs) Handles NumericUpDown1.ValueChanged
        ...
        For j = 0 To DataGridView1.Rows.Count - 1
            If TypeOf DataGridView1.Rows(j).Cells(num).Value Is DBNull = False Then
                'If grdFacturasConsumos.Rows(j).Cells(ColumnasDelGridFacturasConsumos.Deuda).Value < 0 Then
                '    deudanegativa = deudanegativa + grdFacturasConsumos.Rows(j).Cells(ColumnasDelGridFacturasConsumos.Deuda).Value
                'End If

                'DataGridView2.Rows.Add(DataGridView1.Rows(j).Cells(num).Value)
                'DataGridView1.Rows(j).Cells("Recetas").add(DataGridView1.Rows(j).Cells(num).Value)
                ...
                If FirstColumnCell <> "" Then
                    If FirstColumnCell.Contains("F0") Then
                        ...
                        With Row
                            ...
                            .Cells("Codigo").Value = DataGridView1.Rows(j).Cells(0).Value
                            .Cells("Recetas").Value = DataGridView1.Rows(j).Cells(RecetasIndex).Value
                            .Cells("Recaudado").Value = DataGridView1.Rows(j).Cells(RecaudadoIndex).Value
                            .Cells("A cargo OS").Value = DataGridView1.Rows(j).Cells(AcargoOSIndex).Value
                            .Cells("Bonificacion").Value = DataGridView1.Rows(j).Cells(BonificacionIndex).Value
                            .Cells("Total").Value = DataGridView1.Rows(j).Cells(TotalIndex).Value
