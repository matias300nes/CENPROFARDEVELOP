...
#Region "Procedimientos Formularios"
    ...
    Private Sub frmPlanes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        configurarform()
        asignarTags()
        SQL = "exec spPlanes_Select_All 0"
        LlenarGrilla()
        Permitir = True
        CargarCajas()
        PrepararBotones()
    ...
    Private Sub chkEliminados_CheckedChanged(sender As Object, e As EventArgs) Handles chkEliminados.CheckedChanged
        ...
        If chkEliminados.Checked = True Then
            SQL = "exec spPlanes_Select_All @Eliminado = 1"
        Else
            SQL = "exec spPlanes_Select_All @Eliminado = 0"
        End If
...
#Region "Botones"
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        If MessageBox.Show("Está seguro que desea eliminar el Plan seleccionado?", "Atención", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.No Then
            Exit Sub
        End If
        ...
        Try
            ...
            If ds_Almacen.Tables(0).Rows.Count > 0 Then
                MsgBox("No se puede eliminar un Plan que esté asociado a un material. Por favor verifique.", MsgBoxStyle.Information, "Atención")
                Exit Sub
            End If
    ...
    Private Sub btnActivar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnActivar.Click
        ...
        Try
            ...
            ds_Update = SqlHelper.ExecuteDataset(connection, CommandType.Text, "UPDATE Planes SET Eliminado = 0 WHERE id = " & grd.CurrentRow.Cells(0).Value)
            ds_Update.Dispose()
            ...
            Util.MsgStatus(Status1, "El Planes se activó correctamente.", My.Resources.ok.ToBitmap)
    ...
    Private Function AgregarRegistro() As Integer
        ...
        Try
            ...
            Try
                ...
                Try
                    SqlHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, "spPlanes_Insert", param_id, param_codigo, param_nombre, param_porcentaje,
    ...
    Private Function ActualizarRegistro() As Integer
        ...
        Try
            ...
            Try
                ...
                Try
                    SqlHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, "spPlanes_Update", param_id, param_codigo, param_nombre, param_porcentaje,
        ...
        Try
            ...
            Try
                ...
                Try
                    ...
                    SqlHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, "spPlanes_Delete", param_id, param_userdel, param_res)
                    res = param_res.Value
